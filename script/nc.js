/* v1.2.16,1.2.18,1 2018-04-18 21:13:30 */ ! function() {
    function cond() {
        return Math.random()
    }
                ...
                function i(e, t) {
                    this.id = function(e) {
                        ...
                        if (t instanceof Array)
                            for (i = 0, o = t.length; i < o; i++) this.extend(e, t[i], n);
                ...
                function makeNoCaptcha(module_nc, opt, inn_vars, nc_events, Scale, onNCEvent, _) {
                    ...
                    return NoCaptcha.prototype = {
                        init: function(e) {
                            ...
                            e.foreign && (t = "en", default_opt.language = t), _.objUpdate(opt, default_opt), _.objUpdate(opt, e), opt.token || (opt.token = default_opt.token), this.opt = opt, language[opt.language] || (loadExLang(this, opt.language, language),
                        ...
                        inituab: function() {
                            ...
                            UA_Opt.Token = (new Date).getTime() + ":" + opt.token, _.loadjs(util.addHourStamp(ajaxURL.uab_Url), function(t) {
                                if ("timeout" === t) showError(!0, ERR_CODE_UABTIMEOUT), report("loaduab failed"), reportLoadJSError(LOAD_JS_TIMEOUT, "uab.js timeout");
                                else try {
                                    var n = function() {
                        ...
                        destroy: function() {
                            ...
                            if (util.getElementsByClassName("nc-required-js-" + nc_index), e = i.length, e > 0)
                                for (t = 0; t < e; t++) n = i[0].parentNode, n && n.removeChild(i[0])
                        }
                    }, NoCaptcha
                }
                            ...
                            value: function() {
                                ...
                                l.src = this.options.bg_front, l.onload = function() {
                                    ...
                                    for (var e = l.naturalWidth ? [l.naturalWidth, l.naturalHeight] : [l.width, l.height], t = _slicedToArray(e, 2), o = t[0], a = t[1], r = Math.ceil(i.width / o), c = Math.ceil(i.height / a), s = 0; s < c; s++)
                                        for (var d = 0; d < r; d++) n.drawImage(l, d * o, s * a);
